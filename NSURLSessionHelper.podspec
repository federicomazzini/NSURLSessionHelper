#
#  Be sure to run `pod spec lint NSURLSessionHelper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "federicodmazzini" => "federicodmazzini@gmail.com" }
  # Or just: s.author    = "federicom"
  # s.authors            = { "federicom" => "federicom@loyal3.com" }
  # s.social_media_url   = "http://twitter.com/federicom"
  ...
  s.source_files  = "NSURLSessionHelper", "./NSURLSessionHelper/*.{h,m}"
